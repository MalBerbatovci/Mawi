...
//helper class, as canvas' limitation is that rectangles are required in drawing calls,
//therefore we create a single Rectnagle object for each game object and re-use it!
