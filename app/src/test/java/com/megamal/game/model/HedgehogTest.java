...
public class HedgehogTest {
    ...
    public void collisionShouldHappenInXAsValuesAreCloseEnough() {
        ...
        assertNotEquals("X is not close enough", left, testProjectile.getCurrentDirection());
        ...
        //should have collided
        assertNotEquals("X is not close enough", right, testProjectile.getCurrentDirection());
        ...
        //should have collided
        assertNotEquals("TwoTiles not activated", right, testProjectile.getCurrentDirection());
    ...
    public void shouldCollideInYAsProjectileIsCloseEnough() {
        ...
        //should have collided
        assertEquals("X is not close enough", velY, testProjectile.getVelY());
